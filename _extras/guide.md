...
*   Make sure the network is working *before* starting the [Collaborating}({{ site.root }}/02-collab/) section of this lesson.
    [A Better Kind of Backup}({{ site.root }}/01-backup/) focuses on individual use of Mercurial on and can be done without network access.
    [Conflicts}({{ site.root }}/03-conflict/) can also be taught without network access and Bitbucket by creating 2 clones of the repository and pulling changes between them.
...
*   The [Conflicts}({{ site.root }}/03-conflict/) section of the lesson uses the [KDiff3](http://kdiff3.sourceforge.net/) graphical diff/merge tool.
...
## [A Better Kind of Backup}({{ site.root }}/01-backup/)
...
*   This is a good moment to show a diff with the KDiff3 graphical diff tool.
    ...
    show the graphical diff view of a commit on Bitbucket in the [Collaborating}({{ site.root }}/02-collab/) section.
...
## [Collaborating}({{ site.root }}/02-collab/)
...
## [Conflicts}({{ site.root }}/03-conflict/)
...
## [Open Science}({{ site.root }}/04-open/)
